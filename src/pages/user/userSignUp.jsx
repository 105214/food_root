...
import deliveryImage from './image/signup-side.jpg';
...
const UserSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("http://localhost:3001/api/user/signup", formDataToSend, {
...
//     formDataToSend.append("password", formData.password);
//     formDataToSend.append("mobile", formData.mobile);
//     formDataToSend.append("address", formData.address); // Include address
